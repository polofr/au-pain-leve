...
<?php include("includes/navigation.shtml"); ?>
    ...
    <div class="row">
        <div class="box breakfast-box">
            ...
            <div class="col-md-6">
                <img class="img-responsive img-border-right img-rounded" src="./img/buffet_petit_dejeuner.jpg" alt="buffet pour le petit déjeuner">
            </div>
            <div class="clearfix"></div>
            <div class="col-sm-4">
                ...
                <ul>
                    ...
                    <li class="after-asterisk" >4,60€ HT par personne</li>
                </ul>
            </div>
            <div class="col-sm-4">
                ...
                <ul>
                    ...
                    <li>1 mini pain chocolat</li>
                    <li>Jus de fruits des Weppes</li>
                    <li class="after-asterisk" >5,20€ HT par personne</li>
                </ul>
            </div>
            <div class="col-sm-4">
